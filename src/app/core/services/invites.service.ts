...
import { IConfirmation, IDashboardInvite, IUpsertInvite, IUserInvite } from '../models/invites';
...
export class InvitesService {
  ...
  sendConfirmation(invite: IConfirmation, id: string): Observable<IMessageResponse> { 
  ...
  updateInvite(invite: IUpsertInvite, id: string): Observable<IMessageResponse> { 
