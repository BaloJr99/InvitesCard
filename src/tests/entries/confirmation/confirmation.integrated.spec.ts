...
// import { emptyConfirmationEntry, messageResponse, validEntryConfirmation } from "src/tests/mocks/mock";

// describe('Confirmation Component: Integrated Test', () => {
//   let fixture: ComponentFixture<ConfirmationComponent>;
//   const entriesServiceSpy: jasmine.SpyObj<EntriesService> = jasmine.createSpyObj<EntriesService>('EntriesService', ['sendConfirmation']);
...
//   it('authService sendConfirmation() should have been called', () => {
